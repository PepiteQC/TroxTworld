...
var _fleetMap = new Map<string, VehicleDefinition>();
...
export function isVehicleId(id: any): id is VehicleId {
  if (typeof id !== "string" || !id) return false;
  try {
    if (typeof _fleetMap !== "undefined" && _fleetMap && typeof _fleetMap.has === "function") {
      return _fleetMap.has(id);
    }
    if (typeof FLEET !== "undefined" && Array.isArray(FLEET)) {
      return FLEET.some((v: any) => v && v.id === id);
    }
  } catch (_) {}
  return false;
}
