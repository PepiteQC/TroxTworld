...
function paintCounty(
  ...
  for (const f of farmMapMarks()) {
    ...
    ctx.rotate(-(f as any).yaw);
    const rw = ((f as any).w / WORLD.width) * w;
    const rh = ((f as any).d / WORLD.depth) * h;
    ctx.fillStyle = (f as any).illegal ? (opts.labels ? "#3a4a2a" : "#4a5a32") : opts.labels ? "#4a6a32" : "#5a7a3a";
