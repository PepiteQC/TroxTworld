...
export function checkCarryLegality(_licenses: any, _id: any, _rpJob?: any): { ok: boolean; legal: boolean; reason?: string; message?: string } { return { ok: true, legal: true }; }
export function isZoneWeapon(_zone?: string): boolean { return false; }
export function matchCasingToWeapon(_casingId: any, _weaponId?: any): { match: boolean; report: string } { return { match: false, report: '' }; }
export function buildWeaponMesh(_id: string): any { return null; }
export function holdPose(_id: string): { pos: [number, number, number]; rot: [number, number, number]; scale: number } { return { pos: [0, 0, 0], rot: [0, 0, 0], scale: 1 }; }
