...
export const inlandSide: any = 1;
export const pushOffRoad: any = (x: number, z: number) => ({ x, z });
export const villageAxis: any = (v: any) => 0;
export const villageSetback: any = 10;
export const lotHitsThroughRoad: any = () => false;
export const isNearVillage: any = () => false;
export const MAPLE_LEAVES: any = [];
export const deedOffStreet: any = () => false;
export function villageHouseLots(_v: any): Array<{ x: number; z: number; yaw: number }> { return []; }
